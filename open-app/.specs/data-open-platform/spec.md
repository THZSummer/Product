...
| **1.0.11** | **2026-03-30** | **Summer** | **FR-002.1 修正：一个数据集只能选择一种生产方式** |
| **1.0.12** | **2026-03-30** | **Summer** | **1.6 业务流程图重构：合并为一张完整业务流程图（4 个阶段 + 全程审计）** |
| **1.0.13** | **2026-03-30** | **Summer** | **新增 1.6 业务流程图、FR-001.3 数据源类型明确、FR-002 补充生产方式配置参数** |
