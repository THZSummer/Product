...
flowchart TB
    subgraph OP[开放平台<br/>Open Platform]
        subgraph COP[能力开放平台<br/>Capability Open Platform]
            ...
            style Pub fill:#e1f5e1,stroke:#2e7d32
...
|---------|---------|--------|---------|-----------|
| **平台本身能力** | 基础能力 | 应用管理、成员管理、AKSK 管理、权限管理、审批管理、**嵌入能力** | **沿用/重新构建** | 公共底座模块，本身不负责内外连接，被连接能力依赖复用；**嵌入能力**是特有连接能力接入开放平台的基础支撑 |
| | 辅助能力 | 操作日志、应用版本、文档管理 | **沿用现有** | 辅助记录与管理 |
| **连接能力** | **公共连接能力** | API 管理、事件管理、回调管理、连接器管理 | **重新构建/完全新建** | 负责内/对外连接，依赖平台本身能力 |
| | **特有连接能力** | IM 卡片能力、云盘特有业务能力、邮件特有业务能力 | **业务模块建设** | 由各业务模块构建，通过**嵌入能力**接入开放平台，复用平台公共能力 |
...
| **MH-07** | **特有能力嵌入机制** | 业务模块（IM/云盘等）的能力注册接口 | 提供 SDK/API，允许业务模块将特有 API/事件注册到统一平台；复用平台本身的权限与审批 |
...
| v1.8 | 2026-04-14 | **基础能力新增嵌入能力**：<br>- 嵌入能力归入平台本身能力（基础能力），作为特有连接能力接入开放平台的基础支撑<br>- 修正 mermaid 图：特有连接能力通过"嵌入"依赖嵌入能力模块，而非泛泛依赖平台能力<br>- 表格和说明全面对齐，明确"通过嵌入能力接入开放平台，复用平台公共能力" | AI Assistant |
