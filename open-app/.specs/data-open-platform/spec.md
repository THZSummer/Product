...
| **1.0.34** | **2026-03-30** | **Summer** | **第 7 章添加 API 接口清单（6 大模块 21 个接口）** |
| **1.0.35** | **2026-03-30** | **Summer** | **第 7 章接口清单按使用者/模块重组（web-producer/web-consumer/web-admin/生产者系统/消费者系统/普通用户）** |
