...
- **输入**: `.sdd/specs-tree-root/specs-tree-[feature]/tasks.md`（指定要实现的 TASK-XXX）
- **输出**: 实现的代码、测试、文档更新
...
## ⚠️ 前置验证（必须执行）
在开始任务实现前：
1. 检查 `.sdd/specs-tree-root/specs-tree-[feature]/tasks.md` 是否存在
...
### 1. 读取任务
- 从 `.sdd/specs-tree-root/specs-tree-[feature]/tasks.md` 读取任务列表
...
# 你的执行步骤
1. 读取 `.sdd/specs-tree-root/specs-tree-[feature]/tasks.md`
2. 找到 TASK-001 的详细描述
3. 检查前置任务状态
4. 实现代码
5. 编写测试
