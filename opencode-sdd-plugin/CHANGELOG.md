...
### 📝 文档
- 新增 `docs/versions/` 目录管理版本文档
- 新增 `CHANGELOG.md` 版本变更日志
- 新增 `docs/versions/README.md` 版本文档索引
- 新增 `docs/versions/v1.0.0-initial.md` v1.0.0 详细文档
...
### 📖 详细文档
- [Phase 1 完成报告](./docs/versions/v1.1.0-PHASE1.md)
