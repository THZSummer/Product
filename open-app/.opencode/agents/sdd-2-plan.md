...
- **前置条件**: 
  ...
  - ✅ 外部 API 文档已缓存（如适用）
- **输入**: `.sdd/specs-tree-root/specs-tree-[feature]/spec.md`
- **输出**: `.sdd/specs-tree-root/specs-tree-[feature]/plan.md`, `.sdd/specs-tree-root/specs-tree-[feature]/ADR-XXX.md`
...
## 输入
- `.sdd/specs-tree-root/specs-tree-[feature]/spec.md` - 已完成的 Feature Specification

## ⚠️ 前置验证（必须执行）
在开始技术规划前：
1. 检查 `.sdd/specs-tree-root/specs-tree-[feature]/spec.md` 是否存在
...
### 7. 生成 ADR
如果涉及架构决策，在 `.sdd/specs-tree-root/specs-tree-[feature]/` 目录下生成架构决策记录（与 plan.md 同级）：
```markdown
# ADR-XXX: [决策标题]
...
**Feature**: [名称]  
**状态**: planned  
**文件**: `.sdd/specs-tree-root/specs-tree-[feature]/plan.md`
