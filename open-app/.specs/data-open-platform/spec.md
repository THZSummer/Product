...
**需求**:
- FR-002.1: 系统必须支持生产者选择一种或多种数据生产方式
- FR-002.2: 必须支持配置各生产方式的连接信息（如 Kafka Topic、Webhook URL 等）
- FR-002.3: 必须支持连接测试功能
...
| **1.0.7** | **2026-03-30** | **Summer** | **新增用户授权码管理：G27/G28 权限管控、US-012/US-013 用户故事、FR-029~FR-031 功能需求、user_authorizations 数据表、FAT-016~FAT-019 测试用例** |
