...
graph TB
    ...
    subgraph 能力类型
        C1[平台本身能力<br/>应用管理/成员管理/日志]
        C2[公共连接能力<br/>API/事件/回调/连接器]
        C3[特有连接能力<br/>IM/云盘/会议等业务能力]
    end
...
```mermaid
graph TB
    subgraph Capability[能力开放平台]
        subgraph Platform[平台本身能力<br/>内部管理]
            P1[应用管理<br/>沿用现有]
            P2[成员管理<br/>沿用现有]
            P3[操作日志<br/>沿用现有]
        end
        
        subgraph Connection[连接内外业务能力<br/>对外开放]
            subgraph Public[公共连接能力<br/>开放平台自建]
                C1[API 管理<br/>重新构建/AI 开发]
                C2[事件/回调管理<br/>重新构建/AI 开发]
                C3[权限管理<br/>重新构建/AI 开发]
                C4[审批管理<br/>重新构建/AI 开发]
                C5[连接器<br/>完全新建]
            end
            
            subgraph Specific[特有连接能力<br/>业务模块建设/嵌入开放平台]
                S1[IM 业务能力]
                S2[云盘业务能力]
                S3[会议业务能力]
                S4[...]
    ...
    style Specific fill:#fff3cd
```

| 能力大类 | 能力子类 | 建设策略 | 开发方式 |
|---------|---------|---------|---------|
| **平台本身能力** | 应用管理 | 沿用现有代码 | 复用 |
| | 成员管理 | 沿用现有代码 | 复用 |
| | 操作日志 | 沿用现有代码 | 复用 |
| **公共连接能力** | API 管理 | 重新构建 | AI 开发 |
| | 事件/回调管理 | 重新构建 | AI 开发 |
| | 权限管理 | 重新构建 | AI 开发 |
| | 审批管理 | 重新构建 | AI 开发 |
| | 连接器 | 完全新建 | AI 开发 |
| **特有连接能力** | IM/云盘/会议等业务能力 | 业务模块建设，嵌入开放平台 | 按需 |
